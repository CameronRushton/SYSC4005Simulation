...
std_dev_p1_throughput = statistics.stdev(data_p1_throughput)
var_p1_throughput = np.var(data_p1_throughput)
sample_var_p1_throughput = statistics.variance(data_p1_throughput)
CI95_p1_throughput = sms.DescrStatsW(data_p1_throughput).tconfint_mean()
f.write("p1 throughput mean: " + str(mean_p1_throughput) + "\n")
f.write("p1 throughput standard deviation: " + str(std_dev_p1_throughput) + "\n")
...
f.write(
    "p1 throughput 95% confidence interval does not exceed 20% of estimated value?: " + within_20(CI95_p1_throughput,
                                                                                                  mean_p1_throughput) + "\n")
replications = ((1.96 * std_dev_p1_throughput) / throughput_precision) ** 2
f.write("Replications needed: > " + str(replications) + "\n")
f.write("\n")

mean_p2_throughput = np.mean(data_p2_throughput)
std_dev_p2_throughput = statistics.stdev(data_p2_throughput)
var_p2_throughput = np.var(data_p2_throughput)
sample_var_p2_throughput = statistics.variance(data_p2_throughput)
CI95_p2_throughput = sms.DescrStatsW(data_p2_throughput).tconfint_mean()
f.write("p2 throughput mean: " + str(mean_p2_throughput) + "\n")
f.write("p2 throughput standard deviation: " + str(std_dev_p2_throughput) + "\n")
...
f.write(
    "p2 throughput 95% confidence interval does not exceed 20% of estimated value?: " + within_20(CI95_p2_throughput,
                                                                                                  mean_p2_throughput) + "\n")
replications = ((1.96 * std_dev_p2_throughput) / throughput_precision) ** 2
f.write("Replications needed: > " + str(replications) + "\n")
f.write("\n")

mean_p3_throughput = np.mean(data_p3_throughput)
std_dev_p3_throughput = statistics.stdev(data_p3_throughput)
var_p3_throughput = np.var(data_p3_throughput)
sample_var_p3_throughput = statistics.variance(data_p3_throughput)
CI95_p3_throughput = sms.DescrStatsW(data_p3_throughput).tconfint_mean()
f.write("p3 throughput mean: " + str(mean_p3_throughput) + "\n")
f.write("p3 throughput standard deviation: " + str(std_dev_p3_throughput) + "\n")
...
f.write(
    "p3 throughput 95% confidence interval does not exceed 20% of estimated value?: " + within_20(CI95_p3_throughput,
                                                                                                  mean_p3_throughput) + "\n")
replications = ((1.96 * std_dev_p3_throughput) / throughput_precision) ** 2
f.write("Replications needed: > " + str(replications) + "\n")
f.write("\n")

mean_i1_proportion_blocked = np.mean(data_i1_proportion_blocked)
std_dev_i1_proportion_blocked = statistics.stdev(data_i1_proportion_blocked)
var_i1_proportion_blocked = np.var(data_i1_proportion_blocked)
sample_var_i1_proportion_blocked = statistics.variance(data_i1_proportion_blocked)
...
f.write("inspector 1 proportion blocked standard deviation: " + str(std_dev_i1_proportion_blocked) + "\n")
...
replications = ((1.96 * std_dev_i1_proportion_blocked) / proportion_blocked_precision) ** 2
f.write("Replications needed: > " + str(replications) + "\n")
f.write("\n")

mean_i2_proportion_blocked = np.mean(data_i2_proportion_blocked)
std_dev_i2_proportion_blocked = statistics.stdev(data_i2_proportion_blocked)
var_i2_proportion_blocked = np.var(data_i2_proportion_blocked)
sample_var_i2_proportion_blocked = statistics.variance(data_i2_proportion_blocked)
...
f.write("inspector 2 proportion blocked standard deviation: " + str(std_dev_i2_proportion_blocked) + "\n")
...
replications = ((1.96 * std_dev_i2_proportion_blocked) / proportion_blocked_precision) ** 2
f.write("Replications needed: > " + str(replications) + "\n")
f.write("\n")
