...
def calculate_performance(monitor):
    ...
    is_possible = 0 <= (total_c1_queued - monitor.products_made[Type.ONE] - monitor.products_made[Type.TWO] - monitor.products_made[Type.THREE]) <= 9  # TODO: Hard coded magic number
    ...
    avg_queue_time_w3_c3 = convert_to_sim_mins(sum(monitor.component_queue_times[Type.THREE][Type.THREE]) / total_c3_queued)
    ...
    avg_c2_in_w2 = (total_c2_queued / factory_run_time) * avg_queue_time_w2_c2
    avg_c3_in_w3 = (total_c3_queued / factory_run_time) * avg_queue_time_w3_c3
    ...
    if inspector_one.component is not None:
        currently_held_components[inspector_one.component] = 1  # We can set it to one because the inspectors are assigned different types
    ...
    avg_c1_in_sys = (avg_c1_time_blocked + avg_queue_time_w1_c1 + avg_queue_time_w2_c1 + avg_queue_time_w3_c1) * (num_c1_grabbed / factory_run_time)
    avg_c2_in_sys = (avg_c2_time_blocked + avg_queue_time_w2_c2) * (num_c2_grabbed / factory_run_time)
    avg_c3_in_sys = (avg_c3_time_blocked + avg_queue_time_w3_c3) * (num_c3_grabbed / factory_run_time)
